  ...
  return(
    <section className = {styles["landing-screen"]}>
       <div className = {styles.container}>
          ...
          <img className = {`${styles["desktop-image"]} ${styles["top-middle"]}`} src = {kingDeDeDe} alt = "king de de de" />
          <img className = {`${styles["desktop-image"]} ${styles["top-left"]}`} src = {waddleDee} alt = "waddle dee" />
          <img className = {`${styles["desktop-image"]} ${styles["top-right"]}`} src = {metaKnight} alt = "meta knight" />
       </div>
    </section>
  )
}
