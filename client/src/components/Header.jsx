    ...
    <>
      <header className={headerClasses}>
        <div className={styles["container-header"]}>
          ...
          <div className={styles["mobile-icon-container"]} onClick={handleMobileSideBar}>
          ...
          <form
            ...
            className={`${styles["search-bar-form"]} ${styles["desktop-icon-container"]}`}
          >
          ...
          <div className={styles["profile-cart-container"]}>
            <Link to="/" className={styles["desktop-icon-container"]}>
              <i className="fa-2x fa-solid fa-user"></i>
              <span>Sign In/Register</span>
            </Link>
            {cartItems.length === 0 ? (
              <Link to="/cart">
                <img className={styles["cart-icon"]} alt="Empty Cart" src={cartIcon} />
                <span>Cart</span>
              </Link>
            ) : (
              <Link to="/cart">
                <div className={styles["cart-icon-container"]}>
                  ...
                  {cartItemQuantity > 99 ? (
                    ...
                    <p className={`${styles["cart-quantity"]} ${styles["less-than-two-digits"]}`}>
                      {cartItemQuantity}
                    </p>
                  )}
                </div>
